      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 dark:border-gray-700 pb-4">
        ...
        <div className="flex items-center space-x-2 mt-4 sm:mt-0">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-2 text-sm bg-purple-50 dark:bg-purple-900 
                     text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-800
